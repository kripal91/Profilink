...
var bt = class _bt {
  ...
  constructor(t2, e, n) {
    ...
    12.2 === _bt.D(getUA()) && x2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  ...
  static C() {
    ...
    if (_bt.N())
      return true;
    const t2 = getUA(), e = _bt.D(t2), n = 0 < e && e < 10, s = _bt.k(t2), i = 0 < s && s < 4.5;
...
var Ft = class _Ft {
  ...
  isEqual(t2) {
    return t2 instanceof _Ft && t2.projectId === this.projectId && t2.database === this.database;
  }
};
function $t(t2) {
  let e = 0;
...
var Re = class _Re extends Ae {
  ...
  static create(t2, e, n) {
    return t2.isKeyField() ? "in" === e || "not-in" === e ? this.createKeyFieldInFilter(t2, e, n) : new ke(t2, e, n) : "array-contains" === e ? new $e(t2, n) : "in" === e ? new Be(t2, n) : "not-in" === e ? new Le(t2, n) : "array-contains-any" === e ? new qe(t2, n) : new _Re(t2, e, n);
  }
...
var Ge = class _Ge {
  ...
  insert(t2, e) {
    return new _Ge(this.comparator, this.root.insert(t2, e, this.comparator).copy(null, null, je.BLACK, null, null));
  }
  // Returns a copy of the map, with the specified key removed.
  remove(t2) {
    return new _Ge(this.comparator, this.root.remove(t2, this.comparator).copy(null, null, je.BLACK, null, null));
  }
...
var We = class _We {
  ...
  copy(t2) {
    const e = new _We(this.comparator);
    return e.data = t2, e;
  }
};
var ze = class {
...
var Ze = class _Ze {
  ...
  isEqual(t2) {
    return t2 instanceof _Ze && this.key.isEqual(t2.key) && this.version.isEqual(t2.version) && this.documentType === t2.documentType && this.documentState === t2.documentState && this.data.isEqual(t2.data);
  }
  mutableCopy() {
    return new _Ze(this.key, this.documentType, this.version, this.readTime, this.createTime, this.data.clone(), this.documentState);
  }
  toString() {
...
var bs = class _bs {
  ...
  static createSynthesizedRemoteEventForCurrentChange(t2, e, n) {
    const s = /* @__PURE__ */ new Map();
    return s.set(t2, Ps.createSynthesizedTargetChangeForCurrentChange(t2, e, n)), new _bs(st.min(), s, Rs(), ds(), Es());
  }
};
var Ps = class _Ps {
  constructor(t2, e, n, s, i) {
...
var Ir = class _Ir {
  ...
  Ue() {
    ...
    return n.set(this.directionalValue, 0), e !== t2 ? n.set([0], this.directionalValue.length) : ++n[n.length - 1], new _Ir(this.indexId, this.documentKey, this.arrayValue, n);
  }
};
function Tr(t2, e) {
...
var Kr = class _Kr {
  ...
  static withCacheSize(t2) {
    return new _Kr(t2, _Kr.DEFAULT_COLLECTION_PERCENTILE, _Kr.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
  }
};
function Gr(t2, e, n) {
...
var ko = class _ko {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.si = (t3) => Promise.resolve(), !_ko.C())
...
var $o = class _$o {
  ...
  static Ci(t2, e) {
    ...
    return new _$o(t2, e.fromCache, n, s);
  }
};
var Bo = class {
  constructor() {
...
var ru = class _ru {
  ...
  static Zi(t2, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new L2(s.error.code, s.error.message))), r ? new _ru(t2, e, s.state, i) : (x2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var ou = class _ou {
  ...
  static Zi(t2, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new L2(n.error.code, n.error.message))), i ? new _ou(t2, n.state, s) : (x2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  tr() {
    const t2 = {
      state: this.state,
...
var uu = class _uu {
  ...
  static Zi(t2, e) {
    ...
    return s ? new _uu(t2, i) : (x2("SharedClientState", `Failed to parse client data for instance '${t2}': ${e}`), null);
  }
};
var cu = class _cu {
  constructor(t2, e) {
  ...
  static Zi(t2) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new _cu(e.clientId, e.onlineState) : (x2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var au = class {
  constructor() {
...
var nc2 = class _nc {
  ...
  static createAndSchedule(t2, e, n, s, i) {
    const r = Date.now() + n, o = new _nc(t2, e, r, s, i);
    return o.start(n), o;
  }
  /**
...
var ya2 = class _ya {
  ...
  withConverter(t2) {
    return new _ya(this.firestore, t2, this._key);
  }
};
var pa2 = class _pa {
  ...
  withConverter(t2) {
    return new _pa(this.firestore, t2, this._query);
  }
};
var Ia2 = class _Ia extends pa2 {
  /** @hideconstructor */
  constructor(t2, e, n) {
  ...
  withConverter(t2) {
    return new _Ia(this.firestore, t2, this._path);
  }
};
function Ta2(t2, e, ...n) {
...
var Ih = class _Ih {
  ...
  static fromBase64String(t2) {
    try {
      return new _Ih(Qt.fromBase64String(t2));
    } catch (t3) {
   ...
   */
  static fromUint8Array(t2) {
    return new _Ih(Qt.fromUint8Array(t2));
  }
  /**
...
var Sh = class _Sh {
  ...
  ia(t2) {
    return new _Sh(Object.assign(Object.assign({}, this.settings), t2), this.databaseId, this.yt, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  ra(t2) {
    var e;
...
var Oh = class _Oh extends Ah {
  _toFieldTransform(t2) {
    return new Un(t2.path, new kn());
  }
  isEqual(t2) {
    return t2 instanceof _Oh;
  }
};
